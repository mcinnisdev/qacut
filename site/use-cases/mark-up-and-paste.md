...
2. Pick a tool: **Arrow**, **Highlight**, **Blur** or the **Step** counter, and draw on the shot. The keys `A`, `H`, `B` and `S` pick the same tools; `M` goes back to moving marks.
...
01.orig.png   the untouched original
```
