...
<h3>Quick shot</h3>
<p>One shot, one note, Copy for a person or Copy for agent, paste.</p>
</div>
<div class="qc-flow-step">
...
<p class="lead">The quick shot opens in the editor with arrow, highlight, blur and step tools, and a note beside it. Copy puts the picture on the clipboard with the note printed under it, for a chat, an email or a ticket; Copy for agent puts the path and note as text.</p>
...
<div class="qc-mock" role="img" aria-label="The quick shot window: a toolbar with Arrow selected, a screenshot with a coral arrow pointing at a button and a blurred line, and a note panel with Copy and Copy for agent buttons">
...
<span class="b primary">Copy</span>
<span class="b">Copy for agent</span>
</div>
</div>
</div>
</div>
